    ...
    <main class="container">
      <div class="row main-content">
        <div class="card-box">
          <a class="card-image">
            <div
              style="background: url('https://onaug6th-1253668581.cos.ap-guangzhou.myqcloud.com/common/92249761857029110.jpg') no-repeat;"
              class="dont-delete-me"
            ></div>
          </a>
          <div class="card-content">
            ...
            <div class="footer">
              <button class="btn btn-default" @click="readDetail(27)">
                Read Detail
              </button>
        ...
        <div class="card-box" v-for="(item, index) in articleList" :key="index">
          ...
          <div class="card-content">
            ...
            <div class="footer">
              <button class="btn btn-default" @click="readDetail(item.id)">
                Read Detail
              </button>
...
export default {
  ...
  methods: {
    ...
    getArticleList() {
      ...
      this.$http.post("article/list", params).then(result => {
        if (result.code == 0) {
    ...
    srcollToListHead() {
      ...
      //  封面高度
      const headerHeight = document.querySelector(".home-bg").clientHeight - 50;
      //  每次滚动的距离
      const step = scrollHeight / 50;
